...
public class MainActivity extends AppCompatActivity {
    ...
    android.widget.Button msendtop;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        msendtop = findViewById(R.id.SendOTPBtn);
        ...
        msendtop.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                ...
                if (number.isEmpty()) {
                    Toast.makeText(MainActivity.this, "Please inter your number", Toast.LENGTH_SHORT).show();
        ...
        mCallbacks=new PhoneAuthProvider.OnVerificationStateChangedCallbacks() {
            ...
            public void onCodeSent(@NonNull String s, @NonNull PhoneAuthProvider.ForceResendingToken forceResendingToken) {
                ...
                codesent=s;
                Intent intent=new Intent(MainActivity.this,OTP_Autentication.class);
